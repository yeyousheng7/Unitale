        ...
        <div v-if="activeTab === 'prompt'" class="space-y-6">
            <div class="bg-slate-50 p-5 rounded-xl border border-slate-200">
                ...
                <div class="mt-2 text-xs text-slate-500">
                    <span class="font-bold">可用变量:</span> ${sfxSection}, ${bgmSection}, ${bgmExampleLine}, ${sfxExample},
                    ${rawScript}
                </div>
                ...
                <div class="flex justify-between items-center mb-2">
                    ...
                    <div class="space-x-2">
                        <button @click="saveQwenVoiceText"
                            class="px-3 py-1.5 bg-pink-100 text-pink-700 rounded-lg text-xs font-bold hover:bg-pink-200 transition-all">保存生成文本</button>
